  ...
  return (
    <Box
      sx={{
        ...
        background: `linear-gradient(135deg, ${theme?.palette?.secondary?.main || '#D65DB1'} 0%, ${theme?.palette?.primary?.main || '#845EC2'} 100%)`,
        px: 2
      }}
    >
      <Card
      ...
      >
        ...
        >
          ...
          >
            {language === 'en' ? 'Internal Login System' : 'Sistema de Inicio Interno'}
          </Typography>
