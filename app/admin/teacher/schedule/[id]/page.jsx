...
export default function TeacherScheduleDetail({ params }) {
  ...
  // Fetch all teachers and set current teacher
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        ...
        // Find the current teacher index
  ...
  const handlePreviousTeacher = () => {
    if (currentTeacherIndex > 0) {
      const newIndex = currentTeacherIndex - 1;
      setCurrentTeacherIndex(newIndex);
      // Update URL to reflect the new teacher
      router.push(`/admin/teacher/schedule/${allTeachers[newIndex].id}`);
    }
  };
    ...
    >
      ...
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          >
            {currentTeacher ? `${currentTeacher.firstName} ${currentTeacher.lastName}` : translations.teacherSchedule}
          </Typography>
        </Box>
      ...
      <Box sx={{ mt: 2, display: 'flex', flexWrap: 'wrap', gap: 2, justifyContent: 'center' }}>
        <Stack direction="row" spacing={1} alignItems="center">
          <Box sx={{ width: 16, height: 16, backgroundColor: 'rgba(211, 47, 47, 0.1)', border: '1px solid #d32f2f', borderRadius: 0.5 }} />
          <Typography variant="caption">Classes</Typography>
        </Stack>
        <Stack direction="row" spacing={1} alignItems="center">
          <Box sx={{ width: 16, height: 16, backgroundColor: 'rgba(25, 118, 210, 0.1)', border: '1px solid #1976d2', borderRadius: 0.5 }} />
          <Typography variant="caption">Activities</Typography>
        </Stack>
        <Stack direction="row" spacing={1} alignItems="center">
          <Box sx={{ width: 16, height: 16, backgroundColor: 'rgba(46, 125, 50, 0.1)', border: '1px solid #2e7d32', borderRadius: 0.5 }} />
          <Typography variant="caption">Break</Typography>
        </Stack>
        <Stack direction="row" spacing={1} alignItems="center">
          <Box sx={{ width: 16, height: 16, backgroundColor: 'rgba(0, 150, 136, 0.1)', border: '1px dashed #00695c', borderRadius: 0.5 }} />
          <Typography variant="caption">Available</Typography>
        </Stack>
        <Stack direction="row" spacing={1} alignItems="center">
          <Box sx={{ width: 16, height: 16, backgroundColor: 'rgba(158, 158, 158, 0.1)', border: '1px solid #9e9e9e', borderRadius: 0.5 }} />
          <Typography variant="caption">Non-working day</Typography>
        </Stack>
      </Box>
